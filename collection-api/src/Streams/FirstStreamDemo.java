...
public class FirstStreamDemo {
	...
	public static void main(String[] args) {
		...
		//str1.forEach(System.out::println); //foreach is terminal opn
		//System.out.println(str1.count()); // count() is terminal opn
		
		//numbers.stream().distinct().forEach(System.out::println); distinct is intermediate
		
		//System.out.println(numbers.stream().distinct().count());  count is terminal
